...
import dev.trindadedev.tinyinstaller.data.app.model.entity.*
import dev.trindadedev.tinyinstaller.data.app.model.impl.AnalyserRepoImpl
...
import dev.trindadedev.tinyinstaller.data.installer.model.exception.ResolveException
...
class ActionHandler(scope: CoroutineScope, installer: InstallerRepo) :
    ...
    ) = dev.trindadedev.tinyinstaller.data.app.model.impl.InstallerRepoImpl.doWork(config, entities, extra)
